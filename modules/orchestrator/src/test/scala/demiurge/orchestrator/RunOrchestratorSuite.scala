  ...
  test("persists state transitions before side effects") {
    withTempGitRepoAndDb { (repoRoot, conn) =>
      ...
      try {
        ...
        val checkingInspector = new demiurge.inspector.RepoInspector {
        ...
        val checkingCompiler = new demiurge.compiler.RequirementCompiler {
        ...
        val checkingPlanner = new demiurge.planner.EnvironmentPlanner {
