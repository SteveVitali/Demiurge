...
case class BrowserFlowVerifier(
  ...
  requirementId:    String,
  entryUrl:         String,
  actions:          List[demiurge.model.BrowserAction],
  assertions:       List[demiurge.model.Assertion],
  artifactPlan:     List[demiurge.model.ArtifactCapture],
...
case class BrowserVerifierResult(
  ...
  observations: List[demiurge.model.Observation],
